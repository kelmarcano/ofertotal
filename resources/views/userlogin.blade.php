...
<div id="wrapper" class="go-section">
    <div class="row">
        <div class="container">
            <div class="container">
                <!-- Form Name -->
                <h2 class="text-center marginbottom">Inicio de Sesion</h2>
                <form role="form" method="POST" action="{{ route('user.login.submit') }}">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 marginbottom">
                            <a href="{{route('user.reg')}}" class="text-center">Crear una cuenta.</a>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="button style-10" id="LoginButton"><strong>Iniciar Sesion</strong></button>
                        </div>
                        <div class="col-md-4">
                            <a href="{{route('user.forgotpass')}}">Olvide la contraseña?</a>
                        </div>
