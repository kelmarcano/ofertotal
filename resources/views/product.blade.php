                    ...
                    <div class="col-sm-7 col-md-7 information-entry">
                        <div class="product-detail-box">
                            ...
                            @if($productdata->owner != "admin")
                                ...
                                <strong class="">Vendedor: <a href="{{url('/shop')}}/{{$productdata->vendorid}}/{{str_replace(' ','-',strtolower(\App\Vendors::findOrFail($productdata->vendorid)->shop_name))}}" target="_blank">{{\App\Vendors::findOrFail($productdata->vendorid)->shop_name}}</a></strong>
                            @else

                            @endif

                            @if($productdata->stock != 0 || $productdata->stock === null )
                                <h3 class="product-subtitle"><i class="fa fa-check-circle fa-fw"></i> Disponible</h3>
                            @else
                                <h3 class="product-subtitle2"><i class="fa fa-times-circle fa-fw"></i> Agotado</h3>
                            @endif
                            ...
                            <div class="rating-box">
                                ...
                                <div class="rating-number">{{\App\Review::where('productid',$productdata->id)->count()}} Comentarios</div>
                            </div>
                            ...
                            <div class="size-selector detail-info-entry">
                                <div class="detail-info-entry-title">Tamaño</div>
                            ...
                            <div class="detail-info-entry">
                                <form id="cartfrom">
                                    ...
                                    @if($productdata->stock != 0 || $productdata->stock === null )
                                        <button type="button" class="button style-10 to-cart">Agregar al Carrito</button>
                                    @else
                            ...
                            <div class="share-box detail-info-entry">
                                ...
                                <div class="a2a_kit a2a_kit_size_32 a2a_default_style">
                                    <a class="a2a_dd" href="https://www.tcomercia.com"></a>
                                ...
                                <!-- AddToAny END -->
                                <div class="title">Compartir con la redes sociales</div>
            ...
            <div class="information-blocks">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#description" aria-controls="home" role="tab" data-toggle="tab">Descripción Completa</a></li>
                        <li role="presentation"><a href="#policy" aria-controls="profile" role="tab" data-toggle="tab"> Políticas de Devolución</a></li>
                        <li role="presentation"><a href="#reviews" aria-controls="messages" role="tab" data-toggle="tab">Comentarios({{\App\Review::where('productid',$productdata->id)->count()}})</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="reviews">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        <span class='your-choice-was' style='display: none;'>
                                            Tu calificación es: <span class='choice'></span>.
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-md-offset-2">
                                            <button type="submit" class="button style-10" id="LoginButton"><strong>Enviar Comentarios</strong></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            @empty
                                <h4>Aún no se ha dado un comentario.</h4>
                            @endforelse
                        </div>
                    </div>
                </div>
                                    ...
                                    <form>
                                        <p>
                                            ...
                                            @else
                                                <button type="button" class="button style-10 to-cart" disabled>Agotado</button>
                                            @endif
                                            {{--<button type="button" class="button style-10 hidden-sm to-cart"><i class="fa fa-shopping-cart"></i>Agregar al carrito</button>--}}
                                        </p>
                                    </form>
