    ...
    <div id="wrapper" class="go-section">
        <div class="row">
            <div class="container">
                <div class="container">
                    <!-- Form Name -->
                    <h2 class="text-center marginbottom">Registro</h2>
                    ...
                    <form action="{{route('user.reg.submit')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <button type="submit" id="RegButton" class="button style-10" ><strong>Registrar</strong></button>
                            </div>
                        </div>
                        <div class="form-group text-center login">
                            <div class="col-xs-12 col-md-6 col-md-offset-3" style="margin-top: 10px;">
                                <a href="{{route('user.login')}}" class="text-center">Ya tienes una cuenta? Iniciar Sesion</a>
                            </div>
                        </div>
                    </form>
                </div>
