                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <li class=""><a href="#website" data-toggle="tab" aria-expanded="false">Titulo de Sitio Web</a>
                                <li class=""><a href="#payment" data-toggle="tab" aria-expanded="false">Informacion de Pago</a>
                                <li class=""><a href="#background" data-toggle="tab" aria-expanded="false">Imagen de Fondo</a>
                                </li>
                                <li class=""><a href="#about" data-toggle="tab" aria-expanded="false">Quienes Somos</a>
                                </li>
                                <li class=""><a href="#address" data-toggle="tab" aria-expanded="false">Direccion de Oficina</a>
                                </li>
                                <li class=""><a href="#footer" data-toggle="tab" aria-expanded="false">Pie de Pagina</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="tab-pane active" id="logo">
                                    ...
                                    <form method="POST" action="settings/logo" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Logo Actual
                                            </label>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Configurando nuevo Logo <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <button type="submit" class="btn btn-success btn-block">Actualizar Configuracion</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
