...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row" id="main">
                ...
                <div class="go-title">
                    ...
                    <h3>Agregar Imagen al Inicio</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('SliderController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Imagen 1<span class="required">*</span>
                            ...
                            <!-- CODIGO IMAGEN 2 -->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Imagen 2<span class="required">*</span>
 ...
 -->
                             <!-- CODIGO IMAGEN 3 -->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Imagen 3<span class="required">*</span>
 ...
 -->
                             <!-- CODIGO IMAGEN 4 -->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Imagen 4<span class="required">*</span>
