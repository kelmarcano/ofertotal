            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        @endif
                        <div id="response"></div>
                        <form method="POST" action="{!! action('SubChildCategoryController@store') !!}" class="form-horizontal form-label-left">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Child Category<span class="required">*</span>

                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="child" id="child" disabled required>
