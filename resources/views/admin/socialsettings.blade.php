                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('SocialLinkController@update',['social' => $social->id]) !!}" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="instagram" placeholder="Instagram Link" required="required" type="text" value="{{$social->instagram}}">
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    @if($social->inst_status == "enable")
                                        <input type="checkbox" data-toggle="toggle" data-on="Enabled" name="inst_status" value="enable" data-off="Disabled" checked>
                                    @else
                                        <input type="checkbox" data-toggle="toggle" data-on="Enabled" name="inst_status" value="enable" data-off="Disabled">
                                    @endif
                                </div>
                            </div>
