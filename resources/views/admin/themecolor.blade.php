                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('SettingsController@themecolor') !!}" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Seleccionar Color del Tema<span class="required">*</span>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button type="submit" class="btn btn-success btn-block">Actualizar Color</button>
                                </div>
                            </div>
                        </form>
                    </div>
