                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <li><a href="#subchildcat" data-toggle="tab" aria-expanded="true"><strong>SubChild Category</strong></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-xs-12" style="padding: 0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="childcat">
                                 ...
                                 <div class="tab-pane" id="subchildcat">
                                    <div class="go-title">
                                        <div class="pull-right">
                                            <a href="{!! url('admin/subchildcategory/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Sub Child Category</a>
                                        </div>
                                        <h3>Sub Child Category</h3>
                                        <div class="go-line"></div>
                                    </div>
                                    <!-- Page Content -->
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example3" width="100%">
                                                ...
                                                <tbody>
                                                    @foreach($subchild as $data)
                                                        <tr>
                                                            <td>{{$data->mainid->name}}</td>
                                                            <td>{{$data->subid->name}}</td>
                                                            <td>{{$data->subchildid->name}}</td>
                                                            <td>{{$data->name}}</td>
                                                            <td>{{$data->slug}}</td>
                                                            <td>

                                                            <a href="subchildcategory/{{$data->id}}/edit" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit </a>
                                                            <a href="javascript:;" data-href="{{url('/')}}/admin/categories/delete/{{$data->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a><br>
