            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="{!! url('admin/orders') !!}" class="btn btn-default btn-add"><i class="fa fa-arrow-left"></i> Atras</a>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <table class="table">
                            <tbody>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Pedido ID#</strong></td>
                                <td>{{$order->order_number}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Nombre del Cliente:</strong></td>
                                <td>{{$order->customer_name}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Correo del Cliente:</strong></td>
                                <td>{{$order->customer_email}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Teléfono del Cliente:</strong></td>
                                <td>{{$order->customer_phone}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Dirección del Cliente:</strong></td>
                            ...
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Total Productos:</strong></td>
                                <td>{{array_sum($order->quantities)}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Total Costo:</strong></td>
                                <td>${{$order->pay_amount}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Fecha del Pedido:</strong></td>
                                <td>{{$order->booking_date}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Metodo de Pago:</strong></td>
                                <td>{{$order->method}}</td>
                            </tr>
                        @if($order->method != "Cash On Delivery")
                            @if($order->method=="Stripe")
                                <tr>
                                    <td width="30%" style="text-align: right;"><strong>{{$order->method}} Cambiar ID:</strong></td>
                                    <td>{{$order->charge_id}}</td>
                                </tr>
                            @endif
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>{{$order->method}} Transacción ID:</strong></td>
                                <td>{{$order->txnid}}</td>
                            </tr>
                        @endif
                            ...
                            <table class="table">
                                <h4 class="text-center">Pedidos de Productos</h4><hr>
                                <thead>
                                <tr>
                                            ...
                                            <td>
                                                @if($product->owner == "vendor")
                                                    @if(\App\Vendors::where('id',$product->vendorid)->count() > 0)
                                                        {{\App\Vendors::findOrFail($product->vendorid)->shop_name}}
                                                    @else
                                                        <span style="color:red;">Borrar Vendedor Actual</span>
                                                    @endif
                                                @else
                                                    Admin
                                                @endif
