            ...
            <div class="col-xs-12">
                <div class="form-wrap">
                    ...
                    <div class="logo-wrapper">
                            <a href="{{url('/')}}" id="logo">
                                <img width="300px" height="70px" src="{{ URL::asset('assets/images/logo')}}/{{$settings[0]->logo}}">
                            </a>
                        </div>
                    <hr>
                    ...
                    <form action="{{route('vendor.reg.submit')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                <div class="form-group">
                                    <input name="shop_name" placeholder="Nombre de la Tienda" class="form-control" type="text" required>
                                    <p id="nameError" class="errorMsg"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                <div class="form-group">
                                    <input name="phone" placeholder="Numero de Teléfono" class="form-control"  type="text" required>
                                    <p id="nameError" class="errorMsg"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                <div class="form-group">
                                    <input name="password_confirmation" placeholder="Confirmar Password" class="form-control"  type="password" required>
                                    <p id="passError" class="errorMsg"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="submit" id="admin_btn" class="btn btn-custom btn-lg btn-block" value="Registrar">
                            </div>
                        </div>
                        <div class="form-group text-center login">
                            <div class="col-xs-12 col-md-6 col-md-offset-3" style="margin-top: 10px;">
                                <a href="{{route('vendor.login')}}" class="text-center">Ya tienes cuenta? Inicia Sesion</a>
                            </div>
                        </div>
                    </form>
...
<footer id="footer" style="margin-bottom: 30px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p>2021 Powered by <strong><a href="{{url('/')}}" target="_blank">{{$settings[0]->title}}</a></strong></p>
            </div>
        </div>
    </div>
</footer>
