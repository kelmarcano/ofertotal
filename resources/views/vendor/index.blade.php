...
<head>
    ...
    <title>{{$settings[0]->title}} - Panel de Administracion</title>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('assets/css/genius-admin.css')}}" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="form-wrap">
                    <h1>Inicio de Sesion del Vendedor</h1>
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group text-center login">
                            <div class="col-xs-12 col-md-6 col-md-offset-3" style="margin-top: 10px;">
                                <a href="{{route('vendor.reg')}}" class="text-center">Conviertete en Vendedor</a>
                            </div>
                        </div>
                    </form>
