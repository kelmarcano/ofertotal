...
<head>
    ...
    <link href="{{ asset('assets/assets/css/bootstrap-toggle.min.css')}}" rel="stylesheet">
...
<script type="text/javascript" src="{{ asset('assets/assets/js/plugin/nicEdit.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/assets/js/admin-genius.js')}}"></script>
