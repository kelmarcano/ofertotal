        ...
        <div class="container">
            ...
            <div class="col-sm-3">
                <nav class="nav-sidebar">
                    <ul class="nav tabs">
                        <li class="active"><a href="#tab1" data-toggle="tab">Tablero</a></li>
                        <li class=""><a href="#tab2" data-toggle="tab">Actualizacion del Perfil</a></li>
                        <li class=""><a href="#tab3" data-toggle="tab">Cambio de Contraseña</a></li>
                        <li class="">
                            <a href="{{ route('logout') }}"
            ...
            <div class="tab-content">
                <div class="tab-pane active text-style" id="tab1">
                    <h4 class="pull-right">Estas logueado como : {{Auth::user()->name}}</h4>
                ...
                <div class="tab-pane text-style" id="tab2">
                    ...
                    <h2>Actualizar Perfil de Información</h2>
                    <hr>
                    <form method="POST" action="{{ action('UserProfileController@update',['id' => $user->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <button type="submit" class="button style-10" id="LoginButton"><strong>Actualizar Perfil</strong></button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-md-offset-1">
                                    <button type="submit" class="button style-10" id="LoginButton"><strong>Actualizar Contraseña</strong></button>
                                </div>
                            </div>
                            @if(Auth::guest())
                                <p>Logged</p>
