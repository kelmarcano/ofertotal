            ...
            <div class="information-blocks">
                <div class="table-responsive">
                    <table class="cart-table">
                        <tr>
                            ...
                            <th class="column-2">Unidad de Precio</th>
                ...
                <div class="cart-submit-buttons-box">
                    ...
                    <div class="cart-summary-box pull-right col-md-6" style="margin: 0">
                        ...
                        <a class="col-md-4 pull-right button style-10" href="{{route('user.checkout')}}">Comprar</a>
                        <a class="col-md-4 pull-right button style-10" href="{{url('/')}}">Agregar</a>
                    </div>
                    </div>
                </div>
            </div>
