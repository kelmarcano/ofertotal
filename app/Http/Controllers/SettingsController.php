...
class SettingsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('message', 'Titulo actualizado exitosamente.');
    ...
    public function title(Request $request)
    {
        ...
        Session::flash('message', 'Contenido de la pagina actualizado exitosamente.');
        return redirect('admin/settings');
    }
     ...
     //dd($actual_path);
      ...
      // dd($style1);
       ...
       // dd($style2);
        ...
        Session::flash('message', 'Color del Tema actualizado.');
    ...
    public function payment(Request $request)
    {
        ...
        Session::flash('message', 'Informacion de pago actualizado exitosamente.');
        return redirect('admin/settings');
    }
    ...
    public function about(Request $request)
    {
        ...
        Session::flash('message', 'Información Quienes Somos actualizado exitosamente.');
        return redirect('admin/settings');
    }
    ...
    public function footer(Request $request)
    {
        ...
        Session::flash('message', 'Pie de Pagina actualizado exitosamente.');
        return redirect('admin/settings');
    }
    ...
    public function favicon(Request $request)
    {
        ...
        DB::table('settings')
            ->where('id', 1)
            ->update(['favicon' => $name]);
        Session::flash('message', 'Icono de la pestaña actualizado exitosamente.');
        return redirect('admin/settings');
    }
    ...
    public function background(Request $request)
    {
        ...
        Session::flash('message', 'Imagen de fondo actualizado exitosamente.');
        return redirect('admin/settings');
    }
