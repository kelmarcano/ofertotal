...
class SubChildCategoryController extends Controller
{
    ...
    {
        $this->middleware('auth',['except' => 'subchildcats']);
    }
    ...
    {
        $categories = Category::where('role','main')->get();
        return view('admin.subchildcategoryadd',compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $category['role'] = "sub";
        $category->save();
        Session::flash('message', 'New Sub Child Category Added Successfully.');
    ...
    public function subcats($id)
    {
     ...
     public function subchildcats($id)
    {
        $subchildcats = Category::where('mainid', $id)->where('role', 'subchild')->get();
        return response()->json(['response' => $subcats]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.subchildcategoryedit',compact('category','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('message', 'Sub Child Category Updated Successfully.');
        return redirect('admin/categories');
        }
        return redirect()->back()->with('message', 'Category Slug Must Be Unique.');
    }
    ...
    public function destroy($id)
    {
        $category = Category::findOrFail($id);
        $category->delete();
        Session::flash('message', 'Sub Child Category Deleted Successfully.');
        return redirect('admin/categories');
    }
}
